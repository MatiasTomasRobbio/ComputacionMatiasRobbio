...
class ProductoService:
    ...
    def get_lista_estado(self, get_lista_productos, estado):
        lista_estado = dict()
        for key in get_lista_productos:
            if get_lista_productos[key]['_estado'] == estado:
                lista_estado[key] = get_lista_productos[key]
        return lista_estado
    ...
    def update_producto(self, legajo, producto):
        if legajo not in Repositorios.productosList:
